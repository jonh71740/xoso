                  ...
                  <!-- grid column -->
                    <div class="col-12 col-lg-12 col-xl-3">
                        <div class="list-group list-group-bordered mb-3">
                            ...
                            <div class="list-group-item-body"> Thông tin tài khoản </div>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action">
                            <div class="list-group-item-figure">
                            ...
                            <div class="list-group-item-body"> Thay đổi mật khẩu </div>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action">
                            <div class="list-group-item-figure">
                            ...
                            <div class="list-group-item-body"> Cài đặt OTP </div>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action">
                            <div class="list-group-item-figure">
                            ...
                            <div class="list-group-item-body"> Liên kết Telegram </div>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action">
                            <div class="list-group-item-figure">
                                <div class="tile bg-success">
                            ...
                            <div class="list-group-item-body"> Quy tắc </div>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action">
                            <div class="list-group-item-figure">
                                <div class="tile bg-danger">
                            ...
                            <div class="list-group-item-body"> Thông số </div>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action">
                            <div class="list-group-item-figure">
                                <div class="tile bg-warning">
                            ...
                            <div class="list-group-item-body"> Bảng cược </div>
                            </a>
                            
                            <a href="#" class="list-group-item list-group-item-action">
                            <div class="list-group-item-body"> Xổ số truyền thống </div>
                            </a>
                            ...
                            <div class="list-group-item-body"> Sao kê </div>
                            </a>
                            ...
                            <div class="list-group-item-body"> Phiếu đã huỷ </div>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action">
                            <div class="list-group-item-body"> Xổ số truyền thống </div>
                            </a>
                        ...
                        <section class="card card-fluid">
                            ...
                            <div class="card-body">
                                <div class="alert alert-warning has-icon" role="alert">
                                    ...
                                    <p>
                                        Quý hội viên vui lòng cung cấp mật khẩu cũ và mới. Mật khẩu phải bao gồm ít nhất 6 ký tự và phải thoả mãn tối thiểu 3 điều kiện dưới đây
                                    </p> 
                                    <ul>
                                        <li>Có ít nhất một ký tự sử dụng chữ viết HOA</li>
                                        <li>Có ít nhất một ký tự sử dụng chữ viết thường</li>
                                        <li>Có ít nhất một ký tự sử dụng số</li>
                                        <li>Có ít nhất một ký tự sử dụng ký tự đặc biệt</li>
                                    </ul>
                                </div>
                                <div class="form-group">
                                        <div class="form-label-group">
                                            <input type="password" id="inputPassword" class="form-control" placeholder="Mật khẩu cũ" required="">
                                            <label for="inputPassword">Mật khẩu cũ</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <input type="password" id="inputPassword" class="form-control" placeholder="Mật khẩu mới" required="">
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            ...
                                            <label for="inputPassword">Xác nhận mật khẩu mới</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
